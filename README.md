...
## My interests are:
   ...
   * ### Qiskit
   In 2020 I have spent a summer learning about [Qiskit](https://qiskit.org/), quantum SDK for programming quantum computers using Python. I have contributed to Qiskit in many ways, attended [hackathons](https://www.credly.com/badges/7e4653bd-141a-4280-8544-f345fb7232be), and enjoyed being the part of the community. Quantum (and Qiskit) goes in pair with another interest of mine: optimization. CPLEX and DOcplex libraries can be used experimentally with on qubits. :)   
