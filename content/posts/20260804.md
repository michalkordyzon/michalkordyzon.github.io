...
date: 2026-08-04T16:42:36+02:00
draft: false
tags: []
categories: []
ShowToc: false
...
<figure>
  <img src="/images/0007-small.gif" alt="Sample" width="700">
  <figcaption style="color: gray; font-style: normal; text-align: left;">
    Kafka visualisation app
  </figcaption>
</figure>


My quick demo to catch basics is deployed [here](https://kafka-mission-demo.michalkordyzon.workers.dev/).


My friends from Softwaremill (one of the best Confluent/IBM BPs) created somethi much deeper - a very detailed technical visualization showing different scenarios of where and how Kafka can fail (right now about 25 scenarios and soon all 125 scenarios). A great foundation for deeper technical conversations with clients. Their demo is [here](https://monedula.dev/kafka-simulator/).



<figure>
  <img src="/images/0007ss.gif" alt="Sample" width="700">
  <figcaption style="color: gray; font-style: normal; text-align: left;">
    Kafka visualisation app
  </figcaption>
</figure>